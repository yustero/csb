...
print(clustered_matrix_file(topopath.topofiles[2])[-1])
t1=['FOXC2', 'ZEB1', 'ZEB2', 'SNAI1', 'TGFbeta', 'SNAI2', 'TWIST2', 'TWIST1', 'GSC']
t2=['miR101', 'miR141', 'miR200a', 'miR200b', 'miR200c', 'miR34a']
nodes=['FOXC2', 'ZEB1', 'ZEB2', 'SNAI1', 'TGFbeta', 'SNAI2', 'TWIST2', 'TWIST1', 'GSC', 'miR101', 'miR141', 'miR200a', 'miR200b', 'miR200c', 'miR34a']
