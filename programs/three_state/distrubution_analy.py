...
dat=coherent_parser.clustered_matrix_file(topopath.topofiles[0])
adj=dat[0]
t1=len(dat[1])
t2=len(dat[2])
ti=45
...
for i in range(0,n):
    plt.plot(x_axis, mean_dist[i], linestyle="-",marker="o", alpha=0.5,label="node{}".format(i) )
    
indeg_dat=node_metrics.indeg_summary(adj)
print(indeg_dat[0],indeg_dat[1], indeg_dat[2], indeg_dat[3])
